            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {currentQuestion.type === "radio" && (
                  <RadioGroup
                    value={responses[currentStep] as string || undefined}
          ...
          >
            ...
            >
              <Button
                onClick={handleNext}
                className={`px-6 py-2 text-sm font-medium transition-colors ${
                  loading || (!responses[currentStep] && currentQuestion.type !== "textarea")
                    ? 'bg-gray-300 cursor-not-allowed'
                    : 'bg-blue-600 hover:bg-blue-700 text-white'
                }`}
                disabled={loading || (currentQuestion.type !== "textarea" && !responses[currentStep])}
              >
                {loading ? (
